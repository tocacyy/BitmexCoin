...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: bitmexcoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: bitmexcoind.pid)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 17177)") + "\n";
...
strUsage += "\n" + _("Masternode options:") + "\n";
    ...
    strUsage += "  -anonymizebitmexcoinamount=<n> " + _("Keep N Magnet anonymized (default: 0)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    nAnonymizeMagnetAmount = GetArg("-anonymizebitmexcoinamount", 0);
