...
2. run BitmexCoind with -printalert or -sendalert like this:
   /path/to/BitmexCoind -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.BitmexCoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/BitmexCoin Core:0.12.0.58/"));
