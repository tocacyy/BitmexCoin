...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("BitmexCoin Core BitmexCoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  BitmexCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded BitmexCoin transaction") + "\n" +
              "  BitmexCoin-tx [options] -create [commands]   " + _("Create hex-encoded BitmexCoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded BitmexCoin transaction
