    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BMEC-light"), QVariant("light"));
    ui->theme->addItem(QString("BMEC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BMEC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BMEC-traditional"), QVariant("trad"));
