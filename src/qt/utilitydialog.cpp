    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BitmexCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About BitmexCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  BitmexCoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the BitmexCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BMEC, 0.1 BMEC, 1 BMEC and 10 BMEC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://BitmexCoincoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://BitmexCoincoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BitmexCoin Core is shutting down...") + "<br /><br />" +
