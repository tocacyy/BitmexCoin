...
{
    if(fLiteMode) return; // ignore all BitmexCoin related functionality
...
/*
    ...
    allow endless transaction that would bloat BitmexCoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("BitmexCoin-privatesend");
