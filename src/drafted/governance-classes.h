 ...
 *
 *   // network
 *   CBitmexCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.BitmexCoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBitmexCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CBitmexCoinNetwork(UniValue objIn)
    {
...
// // can be under: BitmexCoinNetwork
// //   -- signature requirements : Key1(User)
// class CBitmexCoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == BitmexCoinNetwork);
//     // }
