...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BitmexCoinNetwork") type = BitmexCoinNetwork;
    if(strType == "BitmexCoinNetworkVariable") type = BitmexCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BitmexCoinNetwork) s = "BitmexCoinNetwork";
    if(type == BitmexCoinNetworkVariable) s = "BitmexCoinNetworkVariable";
