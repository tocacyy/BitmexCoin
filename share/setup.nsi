...
!define MUI_HEADERIBMECE
!define MUI_HEADERIBMECE_RIGHT
!define MUI_HEADERIBMECE_BITMAP "../share/pixmaps/nsis-header.bmp"
...
Section -post SEC0001
    ...
    #    WriteRegStr HKCR "bitcoin\bitmexcoin\open\command" "" '"$INSTDIR\bitcoin-qt.exe" "$$1"'
SectionEnd
