...
BitmexCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as BitmexCoin Core, where everyone uses
...
pay attention to for reviewers of BitmexCoin Core code.

General BitmexCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: BitmexCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
