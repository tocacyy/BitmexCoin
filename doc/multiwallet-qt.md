...
Only requiring some minor changes is BitmexCoin.cpp.
...
Changes to BitmexCoin.cpp
----------------------
BitmexCoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
