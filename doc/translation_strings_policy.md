...
This document provides guidelines for internationalization of the BitmexCoin Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to BitmexCoin network</numerusform>
            <numerusform>%n active connections to BitmexCoin network</numerusform>
        </translation>
    </message>
